...
<FAQ
  items={[
    {
      question: "Will this fix work with all DeepSeek R1 versions?",
      answer: "Yes. The thinking tags behavior is consistent across DeepSeek R1 variants (8b, 32b, 70b, distilled versions). The system prompt override works for all of them."
    },
    {
      question: "Do I need to reinstall DeepSeek R1?",
      answer: "No. This is a configuration issue, not a model issue. The fix is applied at runtime through the system prompt. Your DeepSeek R1 installation is working as designed."
    },
    {
      question: "Can I use this with other models like Llama 3?",
      answer: "Yes. The system prompt override works with any model. However, the thinking tags issue is specific to DeepSeek R1. Other models (Llama, Mistral, etc.) don't use thinking tags by default."
    }
  ]}
/>
