...
>
> **< 12GB VRAM:** You will likely hit OOM or run at single-digit tokens/sec. Solution: Cloud GPU
>
> **12GB - 24GB VRAM:** Usable for quantized 7B-14B models. Full-size reasoning models (30B+) will require heavy quantization.
>
> **> 24GB VRAM:** You are in the green zone for local development.
...
|------------------|-------|-----------|
| **GPU Offloading** | 30-100 t/s | Interactive, usable |
...
### Tier B: Gaming Desktops (12GB - 16GB VRAM)

**Typical Specs:** RTX 3060/3070/4060/4070, 8GB-12GB VRAM
...
### Tier A: Workstation / Cloud (24GB+ VRAM)
...
**[Deploy on Vultr (Cloud GPU)](https://www.vultr.com/?ref=9863490)**
...
<div itemScope itemType="https://schema.org/FAQPage">
  <div itemScope itemType="https://schema.org/Question" itemProp="mainEntity">
    <h3 itemProp="name">Why is my inference so slow (0.5 t/s)?</h3>
...
>
> **[Deploy on Vultr (Cloud GPU)](https://www.vultr.com/?ref=9863490)** — Skip the hardware limitations.
