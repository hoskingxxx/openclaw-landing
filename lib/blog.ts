...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "install.ps1 npm ENOENT on Windows (PowerShell Fix)",
    description: "Getting \"install.ps1 cannot be loaded\"? This guide fixes the Execution Policy blocking you. Don't waste time on complex workarounds.",
    date: "2026-02-04",
    author: "LazyDev",
  ...
  },
  {
    ...
    description: "Don't guess. Use this instant VRAM calculator to check if your GPU can run DeepSeek R1/V3 on OpenClaw. Avoid OOM crashes before you deploy.",
    date: "2026-02-05",
    author: "LazyDev",
